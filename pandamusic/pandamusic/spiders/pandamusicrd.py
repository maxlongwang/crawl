...
class PandaMusicRd(scrapy.Spider):
    name = 'pandamusicrd2'
    # allowed_domains = ["xmwav.com/"]
    start_urls = [f"https://www.xmwav.com/msclist/rd.html?classname=rd&page={i}" for i in range(100, 200)]
    # start_urls=[]
    # for i in range(2, 3):
    #     url_page = f"{url}{i}"
    ...
    def parse(self, response):
        url_list = response.xpath('//div[@class="list bgb "]/ul/li/a[1]/@href').getall()
